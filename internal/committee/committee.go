...
func composeOrgRandMapKey(orgID1, orgID2 organization.TypeID) [2]organization.TypeID {
	if orgID1 < orgID2 {
		return [2]organization.TypeID{orgID1, orgID2}
	}
	return [2]organization.TypeID{orgID2, orgID1}
}
