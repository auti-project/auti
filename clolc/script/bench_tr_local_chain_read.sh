...
for i in 1000 10000 100000 1000000; do
    ...
    for j in {1..10}; do
        ...
        ./clolc.out -phase tr -process local_read -numTXs $i -numIter 1 | tee -a $LOG_FILE_DIR
        sleep 1
    done
done
...
for i in 1000 10000 100000 1000000; do
    ...
    for j in {1..10}; do
        echo "No: $j" >>$LOG_FILE_DIR
        ./clolc.out -phase tr -process local_read_all -numTXs $i -numIter 1 | tee -a $LOG_FILE_DIR
        sleep 1
    done
done
